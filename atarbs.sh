...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/at-manos/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/at-manos/atarbs/master/progs.csv"
...
chezmoi init $dotfilesrepo -D /home/$name
chezmoi apply
